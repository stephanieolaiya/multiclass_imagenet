...
# folder_path = '/users/solaiya/controversial_images/sixteen_way_class2'
...
def linear_classifier(predictions_array_train, predictions_array_test):
...
results0= linear_classifier(predictions_array0_train, predictions_array0_test)
distance0= results0[0]
Y_label_table = results0[1]
distance1= linear_classifier(predictions_array1_train, predictions_array1_test)[0]
...
baseline_dist_df.to_csv('/users/solaiya/controversial_images/sixteen_way_class2/baseline_classifier_margins_2500.csv', 
index=False, header= header_list)

harmonized_dist_df.to_csv('/users/solaiya/controversial_images/sixteen_way_class2/harmonized_classifier_margins_2500.csv', 
index=False, header= header_list)


# save the dataframe as a csv file
image_margin_df.to_csv("/users/solaiya/controversial_images/sixteen_way_class2/test_category_info.csv", index=False)

image_filename_df = pd.DataFrame({"Filepaths" : filename_array_train})
# save the dataframe as a csv file
image_filename_df.to_csv("/users/solaiya/controversial_images/sixteen_way_class2/training_filepaths.csv", index=False)
